...
from botCommands.musicbot.playlist import Playlist
from botCommands.musicbot.songinfo import Song
...
class AudioController(object):
    ...
    async def uconnect(self, ctx):
        ...
        if not ctx.author.voice:
            embed=discord.Embed(title="Please join a voice channel before using this command!", colour=config.ERROR_EMBED_COLOR)
